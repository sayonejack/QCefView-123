...
class QCefViewPrivate : public QObject
{
  ...
  public:
    explicit QCefViewPrivate(QCefContextPrivate* ctx, QCefView* view, const QString& url, const QCefSetting* setting = nullptr);
  ...
  public:
    ...
    bool executeJavascriptWithResult(
#if CEF_VERSION_MAJOR > 119
      std::string frameId,
#else
      int64_t frameId,
