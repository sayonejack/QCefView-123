...
void
QCefView::addArchiveResource(const QString& path, const QString& url, const QString& password /*= ""*/, int priority /*= 0*/)
{
    Q_D(QCefView);
...
bool
QCefView::executeJavascriptWithResult(
#if CEF_VERSION_MAJOR > 119
  QString frameId,
#else
  qint64 frameId,
  ...
  const QString& context)
{
    ...
    return d->executeJavascriptWithResult(
#if CEF_VERSION_MAJOR > 119
      frameId.toStdString()
#else
      frameId
